    ...
    return <main>
        <Stack direction="column" spacing={2}>
            ...
            <Typography component="p" variant="body1" sx={{textAlign: "center"}}>
                This is a website that allows you find open rooms to study at UTD. This website is not affiliated with
                UTD.
            </Typography>
            ...
            <Typography component="p" variant="body1" sx={{textAlign: "center"}}>
                CourseBook is periodically scraped to get all of the class sections. Next.js with React is used to
                render the website. The website is hosted on Firebase.
            </Typography>
            <Typography component="h2" variant="h2" sx={{textAlign: "center"}}>Why is it wrong?</Typography>
            <Typography component="p" variant="body1" sx={{textAlign: "center"}}>
                This website is not perfect. It is not guaranteed to be accurate. This website takes information from
                CourseBook, which is not guaranteed to be accurate or up to date.
                If you find a bug, please email me at <a href="mailto:max@maxhogan.dev"
                                                         style={{color: "inherit"}}>max@maxhogan.dev</a>.
            </Typography>
        </Stack>
    </main>
}
